...
from dipy.testing.decorators import fix_random_number_generator
...
@fix_random_number_generator(5324989)
...
@fix_random_number_generator(1924781)
...
@fix_random_number_generator(3121121)
...
@fix_random_number_generator(7711219)
...
@fix_random_number_generator(1271244)
